...
NO ./textures/wall_1.xpm  : 北側の壁（North）
SO ./textures/wall_2.xpm  : 南側の壁（South）
WE ./textures/wall_3.xpm  : 西側の壁（West）
EA ./textures/wall_4.xpm  : 東側の壁（East）

ST ./textures/sky_1.xpm   : 天井のテクスチャ（Sky Texture）
FT ./textures/floor_1.xpm : 床のテクスチャ（Floor Texture）
